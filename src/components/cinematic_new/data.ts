...
import showPreview1 from './assets/mer/show1.png';
import showPreview2 from './assets/mer/show2.png';
import podcastPreview1 from './assets/mer/podcast1.png';
import podcastPreview2 from './assets/mer/podcast2.png';
...
export const cinematicSlides: CinematicSlide[] = [
  ...
  },
  {
    ...
    opened: {
      ...
      services: openedServices,
      previews: [
        { src: showPreview1, alt: 'Стыдно знать кадр 1' },
        { src: showPreview2, alt: 'Стыдно знать кадр 2' },
      ],
  ...
  },
  {
    ...
    opened: {
      ...
      services: openedServices,
      previews: [
        { src: podcastPreview1, alt: 'Выбор кадр 1' },
        { src: podcastPreview2, alt: 'Выбор кадр 2' },
      ],
      navLabel: 'Выбор',
      thumbnailCount: 3,
    },
